...
| tau_g 中位数 (m) | 0.144 |
| tau_g 跨度 (m) | 0.035 |
| legacy PR 100 ms sigma (m) | 2162.444 |
| legacy PR 1 s sigma (m) | 1919.717 |
| 导航历元数 | 219 |
| 平均有效卫星数 | 6.137 |
| Epoch WLS 平均 3D 误差 (m) | 9242.643 |
| EKF PR only 平均 3D 误差 (m) | 51173.370 |
| EKF PR + Doppler 平均 3D 误差 (m) | 18170.678 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 2298.075 |
| PR + Doppler prediction-only epochs | 51 |
| 退化窗口起点 (s) | 10.078 |
| 退化窗口终点 (s) | 12.694 |
...
| legacy PR 100 ms sigma (m) | 2162.444 |
| legacy PR 1 s sigma (m) | 1919.717 |
| legacy PR 1 s RMSE (m) | 2003.350 |
| legacy PR 平均偏置 (m) | -931.351 |
| dynamic RR 100 ms sigma (m/s) | 37.222 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.240 | 73.583 | 20.375 | 4249.535 | 2.606 | 0.154 | 0.800 | -241.581 | 16.779 | 0.767 | 2268.559 | Yes |
| G02 | 61.357 | 65.735 | 20.617 | 4587.611 | 2.742 | 0.164 | -0.600 | -241.581 | 16.779 | 0.767 | 2338.740 | Yes |
| G03 | 109.204 | 55.914 | 21.038 | 3062.415 | 3.017 | 0.185 | 1.100 | -241.581 | 16.779 | 0.767 | 2449.639 | Yes |
| G04 | 151.676 | 45.080 | 21.662 | 521.829 | 3.527 | 0.226 | -0.900 | -241.581 | 16.779 | 0.767 | 2760.507 | Yes |
| G05 | 208.358 | 31.264 | 22.705 | -1625.697 | 4.804 | 0.333 | 0.400 | -241.581 | 16.779 | 0.767 | 3208.155 | Yes |
| G06 | 252.987 | 22.315 | 23.515 | -3105.899 | 6.545 | 0.491 | -0.700 | -241.581 | 8.779 | 0.547 | 57187.794 | Yes |
| G07 | 302.435 | 15.315 | 24.208 | -3822.305 | 9.342 | 0.774 | 1.600 | -241.581 | 8.779 | 0.547 | 88466.614 | Yes |
| G08 | 342.032 | 11.269 | 24.602 | -5033.547 | 12.483 | 1.127 | -1.300 | -241.581 | 8.779 | 0.547 | 109393.723 | Yes |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 9242.643 | - | 6159.917 | - | 5273.747 | - | - | - |
| EKF PR only | 51173.370 | 6042.979 | 19308.159 | 1869.772 | 18046.201 | - | 51 | 0 |
| EKF PR + Doppler | 18170.678 | 2298.075 | 12522.506 | 1412.496 | 8399.904 | 568.033 | 51 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 5.886 | 23009.590 | 312.885 | 5468.463 | 590.400 | 18071.833 | 2344.476 |
| Degraded | 8.000 | 47651.244 | 568.481 | 24410.082 | 445.873 | 18900.610 | 1955.424 |
...
|---|---|---|---|---|
| ekf_pr_only | 51 | 0 | 219 | 6.137 |
| ekf_pr_doppler | 51 | 0 | 219 | 6.137 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.769 | 20.381 | -919.017 | 12163.176 | 76.712 | 100.000 | No |
| G02 | 65.821 | 20.615 | -1022.273 | 12649.713 | 76.712 | 100.000 | No |
| G03 | 55.877 | 21.028 | -1283.667 | 13382.929 | 76.712 | 100.000 | No |
| G04 | 44.933 | 21.648 | -1240.750 | 15293.735 | 76.712 | 100.000 | No |
| G05 | 31.050 | 22.691 | -269.860 | 18965.148 | 76.712 | 100.000 | No |
| G06 | 22.101 | 23.505 | 958.068 | 33306.972 | 76.712 | 100.000 | Yes |
| G07 | 15.164 | 24.205 | 1713.526 | 42583.265 | 76.712 | 100.000 | Yes |
| G08 | 11.225 | 24.608 | 292.744 | 59135.727 | 76.712 | 100.000 | Yes |
