# Ka 19.0 GHz 真实 WKB 单通道背景下的多历元动态多星导航 EKF 实验报告

## 1. 摘要

[../notebooks/ka_multifreq_receiver_common.py](../notebooks/ka_multifreq_receiver_common.py) 提供真实单通道共享链路：
真实电子密度场、真实 WKB、Ka 19.0 GHz PN/BPSK 信号、捕获、DLL / PLL 跟踪，以及单通道
...
| tau_g 中位数 (m) | 0.147 |
| tau_g 跨度 (m) | 0.046 |
| legacy PR 100 ms sigma (m) | 3440.323 |
| legacy PR 1 s sigma (m) | 2771.323 |
| 导航历元数 | 219 |
| 平均有效卫星数 | 6.100 |
| Epoch WLS 平均 3D 误差 (m) | 15360.413 |
| EKF PR only 平均 3D 误差 (m) | 52100.636 |
| EKF PR + Doppler 平均 3D 误差 (m) | 11896.841 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 1902.252 |
| PR + Doppler prediction-only epochs | 52 |
| 退化窗口起点 (s) | 10.078 |
| 退化窗口终点 (s) | 12.694 |
...
3. 用真实传播量生成 Ka 19.0 GHz PN/BPSK 信号。
4. 完成捕获。
5. 完成 DLL / PLL 跟踪。
...
| legacy PR 100 ms sigma (m) | 3440.323 |
| legacy PR 1 s sigma (m) | 2771.323 |
| legacy PR 1 s RMSE (m) | 3037.832 |
| legacy PR 平均偏置 (m) | -1831.711 |
| dynamic RR 100 ms sigma (m/s) | 50.062 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.240 | 73.583 | 20.375 | 4249.535 | 2.606 | 0.159 | 0.800 | -243.583 | 16.270 | 0.782 | 8575.164 | Yes |
| G02 | 61.357 | 65.735 | 20.617 | 4587.611 | 2.742 | 0.169 | -0.600 | -243.583 | 16.270 | 0.782 | 9250.832 | Yes |
| G03 | 109.204 | 55.914 | 21.038 | 3062.415 | 3.017 | 0.191 | 1.100 | -243.583 | 16.270 | 0.782 | 8806.053 | Yes |
| G04 | 151.676 | 45.080 | 21.662 | 521.829 | 3.527 | 0.232 | -0.900 | -243.583 | 16.270 | 0.782 | 12084.106 | Yes |
| G05 | 208.358 | 31.264 | 22.705 | -1625.697 | 4.804 | 0.343 | 0.400 | -243.583 | 16.270 | 0.782 | 14996.518 | Yes |
| G06 | 252.987 | 22.315 | 23.515 | -3105.899 | 6.545 | 0.506 | -0.700 | -243.583 | 8.270 | 0.562 | 246446.785 | Yes |
| G07 | 302.435 | 15.315 | 24.208 | -3822.305 | 9.342 | 0.797 | 1.600 | -243.583 | 8.270 | 0.562 | 260953.129 | Yes |
| G08 | 342.032 | 11.269 | 24.602 | -5033.547 | 12.483 | 1.161 | -1.300 | -243.583 | 8.270 | 0.562 | 438317.848 | Yes |
...
| 有效 WLS epoch 数 | 167 |
| 无效 WLS epoch 数 | 52 |
| 平均 3D 位置误差 (m) | 15360.413 |
| 平均 |钟差误差| (m) | 9709.453 |
| 平均残差 RMS (m) | 11134.279 |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 15360.413 | - | 9709.453 | - | 11134.279 | - | - | - |
| EKF PR only | 52100.636 | 6231.249 | 7185.819 | 1160.380 | 27724.469 | - | 52 | 0 |
| EKF PR + Doppler | 11896.841 | 1902.252 | 6868.604 | 1046.586 | 14408.993 | 564.718 | 52 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 5.845 | 38937.288 | 443.939 | 8017.878 | 568.137 | 12145.272 | 1957.452 |
| Degraded | 8.000 | 98774.876 | 996.941 | 49068.501 | 546.173 | 10052.712 | 1492.500 |
...
|---|---|---|---|---|
| ekf_pr_only | 52 | 0 | 219 | 6.100 |
| ekf_pr_doppler | 52 | 0 | 219 | 6.100 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.769 | 20.381 | -919.017 | 20726.401 | 76.256 | 100.000 | No |
| G02 | 65.821 | 20.615 | -1022.273 | 21438.436 | 76.256 | 100.000 | No |
| G03 | 55.877 | 21.028 | -1283.667 | 22842.841 | 76.256 | 100.000 | No |
| G04 | 44.933 | 21.648 | -1240.750 | 25770.335 | 76.256 | 100.000 | No |
| G05 | 31.050 | 22.691 | -269.860 | 31861.812 | 76.256 | 100.000 | No |
| G06 | 22.101 | 23.505 | 958.068 | 59423.738 | 76.256 | 100.000 | Yes |
| G07 | 15.164 | 24.205 | 1713.526 | 77084.046 | 76.256 | 100.000 | Yes |
| G08 | 11.225 | 24.608 | 292.744 | 109182.739 | 76.256 | 100.000 | Yes |
