...
| tau_g 中位数 (m) | 0.143 |
| tau_g 跨度 (m) | 0.027 |
| legacy PR 100 ms sigma (m) | 149.173 |
| legacy PR 1 s sigma (m) | 45.499 |
| 导航历元数 | 219 |
| 平均有效卫星数 | 6.685 |
| Epoch WLS 平均 3D 误差 (m) | 355.631 |
| EKF PR only 平均 3D 误差 (m) | 816.071 |
| EKF PR + Doppler 平均 3D 误差 (m) | 1.193 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 0.007 |
| PR + Doppler prediction-only epochs | 36 |
| 退化窗口起点 (s) | 10.078 |
| 退化窗口终点 (s) | 12.694 |
...
| legacy PR 100 ms sigma (m) | 149.173 |
| legacy PR 1 s sigma (m) | 45.499 |
| legacy PR 1 s RMSE (m) | 44.418 |
| legacy PR 平均偏置 (m) | -0.600 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.240 | 73.583 | 20.375 | 4249.535 | 2.606 | 0.152 | 0.800 | -207.584 | 16.955 | 0.798 | 580.009 | Yes |
| G02 | 61.357 | 65.735 | 20.617 | 4587.611 | 2.742 | 0.162 | -0.600 | -207.584 | 16.955 | 0.798 | 537.097 | Yes |
| G03 | 109.204 | 55.914 | 21.038 | 3062.415 | 3.017 | 0.182 | 1.100 | -207.584 | 16.955 | 0.798 | 515.495 | Yes |
| G04 | 151.676 | 45.080 | 21.662 | 521.829 | 3.527 | 0.222 | -0.900 | -207.584 | 16.955 | 0.798 | 655.745 | Yes |
| G05 | 208.358 | 31.264 | 22.705 | -1625.697 | 4.804 | 0.327 | 0.400 | -207.584 | 16.955 | 0.798 | 884.458 | Yes |
| G06 | 252.987 | 22.315 | 23.515 | -3105.899 | 6.545 | 0.483 | -0.700 | -207.584 | 8.955 | 0.578 | 12637.037 | Yes |
| G07 | 302.435 | 15.315 | 24.208 | -3822.305 | 9.342 | 0.760 | 1.600 | -207.584 | 8.955 | 0.578 | 16720.910 | Yes |
| G08 | 342.032 | 11.269 | 24.602 | -5033.547 | 12.483 | 1.107 | -1.300 | -207.584 | 8.955 | 0.578 | 23043.909 | Yes |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 355.631 | - | 274.886 | - | 254.264 | - | - | - |
| EKF PR only | 816.071 | 136.116 | 634.393 | 117.098 | 449.015 | - | 36 | 0 |
| EKF PR + Doppler | 1.193 | 0.007 | 19.250 | 0.010 | 358.860 | 0.985 | 36 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 6.591 | 726.577 | 0.020 | 189.085 | 1.128 | 1.313 | 0.006 |
| Degraded | 7.385 | 4235.071 | 0.105 | 1483.619 | 0.041 | 0.442 | 0.012 |
...
|---|---|---|---|---|
| ekf_pr_only | 36 | 0 | 125 | 6.685 |
| ekf_pr_doppler | 36 | 0 | 70 | 6.685 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.769 | 20.381 | -919.017 | 403.445 | 83.562 | 92.308 | No |
| G02 | 65.821 | 20.615 | -1022.273 | 416.930 | 83.562 | 92.308 | No |
| G03 | 55.877 | 21.028 | -1283.667 | 441.396 | 83.562 | 92.308 | No |
| G04 | 44.933 | 21.648 | -1240.750 | 496.857 | 83.562 | 92.308 | No |
| G05 | 31.050 | 22.691 | -269.860 | 619.618 | 83.562 | 92.308 | No |
| G06 | 22.101 | 23.505 | 958.068 | 1626.756 | 83.562 | 92.308 | Yes |
| G07 | 15.164 | 24.205 | 1713.526 | 2111.689 | 83.562 | 92.308 | Yes |
| G08 | 11.225 | 24.608 | 292.744 | 3028.193 | 83.562 | 92.308 | Yes |
