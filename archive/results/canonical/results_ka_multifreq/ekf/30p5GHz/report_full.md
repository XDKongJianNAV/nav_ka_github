...
| tau_g 中位数 (m) | 0.142 |
| tau_g 跨度 (m) | 0.022 |
| legacy PR 100 ms sigma (m) | 144.443 |
| legacy PR 1 s sigma (m) | 26.134 |
| 导航历元数 | 219 |
| 平均有效卫星数 | 6.758 |
| Epoch WLS 平均 3D 误差 (m) | 318.701 |
| EKF PR only 平均 3D 误差 (m) | 2177.915 |
| EKF PR + Doppler 平均 3D 误差 (m) | 1.813 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 0.006 |
| PR + Doppler prediction-only epochs | 34 |
| 退化窗口起点 (s) | 10.078 |
| 退化窗口终点 (s) | 12.694 |
...
| legacy PR 100 ms sigma (m) | 144.443 |
| legacy PR 1 s sigma (m) | 26.134 |
| legacy PR 1 s RMSE (m) | 27.097 |
| legacy PR 平均偏置 (m) | -7.558 |
| dynamic RR 100 ms sigma (m/s) | 0.004 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.240 | 73.583 | 20.375 | 4249.535 | 2.606 | 0.151 | 0.800 | -241.968 | 17.405 | 0.963 | 142.435 | Yes |
| G02 | 61.357 | 65.735 | 20.617 | 4587.611 | 2.742 | 0.161 | -0.600 | -241.968 | 17.405 | 0.963 | 143.355 | Yes |
| G03 | 109.204 | 55.914 | 21.038 | 3062.415 | 3.017 | 0.182 | 1.100 | -241.968 | 17.405 | 0.963 | 173.225 | Yes |
| G04 | 151.676 | 45.080 | 21.662 | 521.829 | 3.527 | 0.221 | -0.900 | -241.968 | 17.405 | 0.963 | 202.748 | Yes |
| G05 | 208.358 | 31.264 | 22.705 | -1625.697 | 4.804 | 0.326 | 0.400 | -241.968 | 17.405 | 0.963 | 256.808 | Yes |
| G06 | 252.987 | 22.315 | 23.515 | -3105.899 | 6.545 | 0.482 | -0.700 | -241.968 | 9.405 | 0.743 | 4734.834 | Yes |
| G07 | 302.435 | 15.315 | 24.208 | -3822.305 | 9.342 | 0.758 | 1.600 | -241.968 | 9.405 | 0.743 | 5536.562 | Yes |
| G08 | 342.032 | 11.269 | 24.602 | -5033.547 | 12.483 | 1.105 | -1.300 | -241.968 | 9.405 | 0.743 | 8795.376 | Yes |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 318.701 | - | 259.894 | - | 245.578 | - | - | - |
| EKF PR only | 2177.915 | 435.509 | 1514.501 | 285.475 | 657.527 | - | 34 | 0 |
| EKF PR + Doppler | 1.813 | 0.006 | 11.439 | 0.011 | 347.007 | 0.705 | 34 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 6.591 | 709.881 | 0.015 | 183.585 | 0.817 | 1.981 | 0.006 |
| Degraded | 8.000 | 2500.782 | 0.048 | 1346.397 | 0.022 | 0.758 | 0.011 |
...
|---|---|---|---|---|
| ekf_pr_only | 34 | 0 | 193 | 6.758 |
| ekf_pr_doppler | 34 | 0 | 69 | 6.758 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.769 | 20.381 | -919.017 | 380.962 | 84.475 | 100.000 | No |
| G02 | 65.821 | 20.615 | -1022.273 | 391.971 | 84.475 | 100.000 | No |
| G03 | 55.877 | 21.028 | -1283.667 | 420.212 | 84.475 | 100.000 | No |
| G04 | 44.933 | 21.648 | -1240.750 | 464.669 | 84.475 | 100.000 | No |
| G05 | 31.050 | 22.691 | -269.860 | 579.183 | 84.475 | 100.000 | No |
| G06 | 22.101 | 23.505 | 958.068 | 1238.834 | 84.475 | 100.000 | Yes |
| G07 | 15.164 | 24.205 | 1713.526 | 1603.365 | 84.475 | 100.000 | Yes |
| G08 | 11.225 | 24.608 | 292.744 | 2300.803 | 84.475 | 100.000 | Yes |
