...
| tau_g 中位数 (m) | 0.144 |
| tau_g 跨度 (m) | 0.035 |
| legacy PR 100 ms sigma (m) | 144.944 |
| legacy PR 1 s sigma (m) | 36.461 |
| 导航历元数 | 219 |
| 平均有效卫星数 | 6.429 |
| Epoch WLS 平均 3D 误差 (m) | 470.618 |
| EKF PR only 平均 3D 误差 (m) | 376.939 |
| EKF PR + Doppler 平均 3D 误差 (m) | 18.988 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 0.040 |
| PR + Doppler prediction-only epochs | 43 |
| 退化窗口起点 (s) | 10.078 |
| 退化窗口终点 (s) | 12.694 |
...
| legacy PR 100 ms sigma (m) | 144.944 |
| legacy PR 1 s sigma (m) | 36.461 |
| legacy PR 1 s RMSE (m) | 35.933 |
| legacy PR 平均偏置 (m) | -4.019 |
| dynamic RR 100 ms sigma (m/s) | 0.039 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.240 | 73.583 | 20.375 | 4249.535 | 2.606 | 0.154 | 0.800 | -209.081 | 16.398 | 0.892 | 406.059 | Yes |
| G02 | 61.357 | 65.735 | 20.617 | 4587.611 | 2.742 | 0.164 | -0.600 | -209.081 | 16.398 | 0.892 | 418.621 | Yes |
| G03 | 109.204 | 55.914 | 21.038 | 3062.415 | 3.017 | 0.185 | 1.100 | -209.081 | 16.398 | 0.892 | 438.471 | Yes |
| G04 | 151.676 | 45.080 | 21.662 | 521.829 | 3.527 | 0.226 | -0.900 | -209.081 | 16.398 | 0.892 | 494.115 | Yes |
| G05 | 208.358 | 31.264 | 22.705 | -1625.697 | 4.804 | 0.333 | 0.400 | -209.081 | 16.398 | 0.892 | 574.241 | Yes |
| G06 | 252.987 | 22.315 | 23.515 | -3105.899 | 6.545 | 0.491 | -0.700 | -209.081 | 8.398 | 0.672 | 11510.875 | Yes |
| G07 | 302.435 | 15.315 | 24.208 | -3822.305 | 9.342 | 0.774 | 1.600 | -209.081 | 8.398 | 0.672 | 17806.739 | Yes |
| G08 | 342.032 | 11.269 | 24.602 | -5033.547 | 12.483 | 1.127 | -1.300 | -209.081 | 8.398 | 0.672 | 22018.989 | Yes |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 470.618 | - | 362.659 | - | 299.955 | - | - | - |
| EKF PR only | 376.939 | 105.473 | 216.074 | 44.007 | 448.310 | - | 43 | 0 |
| EKF PR + Doppler | 18.988 | 0.040 | 22.087 | 0.020 | 427.378 | 0.876 | 43 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 6.342 | 935.219 | 0.196 | 248.824 | 0.971 | 20.515 | 0.042 |
| Degraded | 7.077 | 4662.573 | 0.834 | 1615.154 | 0.240 | 9.420 | 0.025 |
...
|---|---|---|---|---|
| ekf_pr_only | 43 | 0 | 97 | 6.429 |
| ekf_pr_doppler | 43 | 0 | 91 | 6.429 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.769 | 20.381 | -919.017 | 512.908 | 80.365 | 88.462 | No |
| G02 | 65.821 | 20.615 | -1022.273 | 538.747 | 80.365 | 88.462 | No |
| G03 | 55.877 | 21.028 | -1283.667 | 567.742 | 80.365 | 88.462 | No |
| G04 | 44.933 | 21.648 | -1240.750 | 643.866 | 80.365 | 88.462 | No |
| G05 | 31.050 | 22.691 | -269.860 | 801.684 | 80.365 | 88.462 | No |
| G06 | 22.101 | 23.505 | 958.068 | 1931.741 | 80.365 | 88.462 | Yes |
| G07 | 15.164 | 24.205 | 1713.526 | 2518.154 | 80.365 | 88.462 | Yes |
| G08 | 11.225 | 24.608 | 292.744 | 3507.044 | 80.365 | 88.462 | Yes |
