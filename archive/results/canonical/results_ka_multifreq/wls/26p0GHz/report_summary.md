...
- 真实 `tau_g` 中位数：0.1433 m
- 真实 `tau_g` 跨度：0.0349 m
- 单通道伪距误差 100 ms 平滑 sigma：146.614 m
- 单通道伪距误差 1 s 平滑 sigma：43.742 m
- 单通道伪距误差 1 s 平滑 RMSE：42.917 m
...
- LS 3D 位置误差：13.304 m
- WLS 3D 位置误差：11.587 m
- PDOP：3.556

实验 B：

- LS 3D 位置误差：250.626 m
- WLS 3D 位置误差：69.876 m
- PDOP：2.104

Monte Carlo（基于实验 B，120 次）：

- LS：均值 141.282 m，标准差 103.534 m，90% 分位数 279.027 m
- WLS：均值 96.236 m，标准差 56.327 m，90% 分位数 182.226 m
