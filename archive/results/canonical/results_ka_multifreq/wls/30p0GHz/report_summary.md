...
- 真实 `tau_g` 中位数：0.1424 m
- 真实 `tau_g` 跨度：0.0242 m
- 单通道伪距误差 100 ms 平滑 sigma：144.747 m
- 单通道伪距误差 1 s 平滑 sigma：48.891 m
- 单通道伪距误差 1 s 平滑 RMSE：48.110 m
...
- LS 3D 位置误差：14.870 m
- WLS 3D 位置误差：12.950 m
- PDOP：3.556

实验 B：

- LS 3D 位置误差：280.128 m
- WLS 3D 位置误差：78.101 m
- PDOP：2.104

Monte Carlo（基于实验 B，120 次）：

- LS：均值 149.362 m，标准差 91.040 m，90% 分位数 262.350 m
- WLS：均值 101.136 m，标准差 54.722 m，90% 分位数 173.022 m
