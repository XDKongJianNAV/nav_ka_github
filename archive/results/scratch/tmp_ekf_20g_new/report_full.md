# Ka 20.0 GHz 真实 WKB 单通道背景下的多历元动态多星导航 EKF 实验报告

## 1. 摘要

[../notebooks/ka_multifreq_receiver_common.py](../notebooks/ka_multifreq_receiver_common.py) 提供真实单通道共享链路：
真实电子密度场、真实 WKB、Ka 20.0 GHz PN/BPSK 信号、捕获、DLL / PLL 跟踪，以及单通道
...
| tau_g 中位数 (m) | 0.146 |
| tau_g 跨度 (m) | 0.043 |
| legacy PR 100 ms sigma (m) | 164.284 |
| legacy PR 1 s sigma (m) | 64.012 |
| 导航历元数 | 43 |
| 平均有效卫星数 | 6.140 |
| Epoch WLS 平均 3D 误差 (m) | 332.390 |
| EKF PR only 平均 3D 误差 (m) | 452.566 |
| EKF PR + Doppler 平均 3D 误差 (m) | 67.056 |
| EKF PR + Doppler 平均 3D 速度误差 (m/s) | 0.119 |
| PR + Doppler prediction-only epochs | 10 |
| 退化窗口起点 (s) | 9.910 |
| 退化窗口终点 (s) | 12.430 |
...
3. 用真实传播量生成 Ka 20.0 GHz PN/BPSK 信号。
4. 完成捕获。
5. 完成 DLL / PLL 跟踪。
...
| 量 | 最小值 | 中位数 | 最大值 |
|---|---|---|---|
| Azimuth span (deg) | 0.606 | 0.722 | 1.058 |
| Elevation span (deg) | 0.392 | 0.538 | 0.731 |
| Range span (km) | 23.695 | 27.050 | 34.435 |
| Range-rate span (m/s) | 9324.298 | 9345.087 | 9360.801 |
...
| legacy PR 100 ms sigma (m) | 164.284 |
| legacy PR 1 s sigma (m) | 64.012 |
| legacy PR 1 s RMSE (m) | 64.134 |
| legacy PR 平均偏置 (m) | 15.522 |
| dynamic RR 100 ms sigma (m/s) | 0.044 |
...
代表性 epoch 取退化段中的代表时刻 `t = 11.250 s`。逐星组成如下：
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| G01 | 18.236 | 73.580 | 20.374 | 4097.765 | 2.606 | 0.156 | 0.800 | -9.250 | 16.687 | 0.938 | 76.935 | Yes |
| G02 | 61.358 | 65.725 | 20.616 | 4636.204 | 2.742 | 0.166 | -0.600 | -9.250 | 16.687 | 0.938 | 88.076 | Yes |
| G03 | 109.184 | 55.903 | 21.037 | 3296.617 | 3.018 | 0.187 | 1.100 | -9.250 | 16.687 | 0.938 | 100.439 | Yes |
| G04 | 151.663 | 45.071 | 21.662 | 870.545 | 3.528 | 0.227 | -0.900 | -9.250 | 16.687 | 0.938 | 96.232 | Yes |
| G05 | 208.336 | 31.259 | 22.705 | -1268.491 | 4.805 | 0.335 | 0.400 | -9.250 | 16.687 | 0.938 | 128.071 | Yes |
| G06 | 252.980 | 22.317 | 23.516 | -2848.501 | 6.545 | 0.495 | -0.700 | -9.250 | 8.687 | 0.718 | 1982.964 | Yes |
| G07 | 302.431 | 15.322 | 24.209 | -3743.173 | 9.338 | 0.780 | 1.600 | -9.250 | 8.687 | 0.718 | 3025.102 | Yes |
| G08 | 342.044 | 11.279 | 24.603 | -5156.908 | 12.473 | 1.135 | -1.300 | -9.250 | 8.687 | 0.718 | 3950.768 | Yes |
...
|---|---|---|---|---|---|---|---|---|
| Epoch WLS | 332.390 | - | 207.826 | - | 173.460 | - | - | - |
| EKF PR only | 452.566 | 86.279 | 297.475 | 56.111 | 269.434 | - | 10 | 0 |
| EKF PR + Doppler | 67.056 | 0.119 | 60.248 | 0.053 | 248.047 | 0.912 | 10 | 0 |
...
|---|---|---|---|---|---|---|---|
| Normal | 5.895 | 696.117 | 0.306 | 111.643 | 0.975 | 68.998 | 0.122 |
| Degraded | 8.000 | 2473.950 | 1.009 | 1011.912 | 0.561 | 54.628 | 0.097 |
...
|---|---|---|---|---|
| ekf_pr_only | 10 | 0 | 17 | 6.140 |
| ekf_pr_doppler | 10 | 0 | 16 | 6.140 |
...
|---|---|---|---|---|---|---|---|
| G01 | 73.774 | 20.381 | -859.246 | 368.842 | 76.744 | 100.000 | No |
| G02 | 65.827 | 20.615 | -999.492 | 387.316 | 76.744 | 100.000 | No |
| G03 | 55.883 | 21.029 | -1304.777 | 411.449 | 76.744 | 100.000 | No |
| G04 | 44.937 | 21.649 | -1299.349 | 460.991 | 76.744 | 100.000 | No |
| G05 | 31.050 | 22.691 | -348.103 | 581.114 | 76.744 | 100.000 | No |
| G06 | 22.099 | 23.505 | 883.947 | 1195.022 | 76.744 | 100.000 | Yes |
| G07 | 15.159 | 24.205 | 1666.053 | 1518.404 | 76.744 | 100.000 | Yes |
| G08 | 11.218 | 24.608 | 286.337 | 2299.599 | 76.744 | 100.000 | Yes |
