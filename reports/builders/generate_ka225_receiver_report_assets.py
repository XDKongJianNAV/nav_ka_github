...
import numpy as np
from nav_ka.legacy import nb_ka225_rx_from_real_wkb_debug as mod
...
def main() -> None:
    ...
    large_csv = ROOT / "data" / "raw" / "Large_Scale_Ne_Smooth.csv"
    aoa_csv = ROOT / "data" / "raw" / "RAMC_AOA_Sim_Input.csv"
