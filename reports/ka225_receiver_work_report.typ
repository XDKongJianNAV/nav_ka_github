...
#grid(
  ...
  gutter: 8pt,
  card("文档目的", [
    本文档给出 `notebooks/nb_ka225_rx_from_real_wkb_debug.py` 的接收机侧技术重构说明。内容覆盖脚本内部组织、运行流程、信号模型、捕获与跟踪方程、调试出口、图像资产与最终性能。
  ], fill: blue),
  card("交付边界", [
