...
uv run python reports/generate_ka225_receiver_report_assets.py
~/.cargo/bin/typst compile \
  --font-path "$FONT_DIR" \
  reports/ka225_receiver_work_report.typ \
  reports/ka225_receiver_work_report.pdf
...
uv run python reports/build_ka225_receiver_report_docx.py
